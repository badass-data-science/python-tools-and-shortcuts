...
from python_tools_and_shortcuts.time_series_essentials.freq_and_period import get_frequency_in_hertz_from_period_in_seconds
from python_tools_and_shortcuts.time_series_essentials.freq_and_period import get_sinusoidal_period_from_frequency_in_hertz
